<?php                                                                                
  ...
  if($_POST["segment"] == "upload_img_insert") {  
  $Type=[
   'jpg'         =>"ada",
   'png'         =>"ada",
   'jpeg'        =>"ada",
  ...
  if (empty($val["error"])) {
     ...
     $data = array(                                                             
      ...
      $result=$db->que($data)->insert("demo");
       tatiyeNet::redDuplicat('demo','upload');                                                                              
  ...
  #| Develover Tatiye.Net 2023                                                  
  #| @Date  Rabu 21 Juni 2023, 03:32:01 PM                                      
  } elseif ($_POST["segment"] == "upload_img_update") {                         
    $val=tatiyeNet::validation([                                                
  ...
  if (empty($val["error"])) {                                                   
     $data = array(                                                             
      ...
      $result=$db->que($data)->update("demo","id =`1` AND user_id='".."' ");         
      $val["hasil"]    ="sukses";                                               
  } else {                                                                      
      $val["hasil"]    ="error";                                                
   };                                                                           
